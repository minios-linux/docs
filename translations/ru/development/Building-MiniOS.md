...
Процесс сборки проходит по структурированной последовательности этапов:
...
Каждая директория окружения содержит символические ссылки на директории модулей в `linux-live/scripts/`:
